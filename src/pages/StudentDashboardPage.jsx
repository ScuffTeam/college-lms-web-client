...
import { Route, useLocation, A, useNavigate } from '@solidjs/router';
        ...
        <>
            <header class={styles.header}>
                <div class={styles['header-content']}>
                    ...
                    <nav class={`${styles['nav-menu']} ${isMobileMenuOpen() ? styles.active : ''}`}>
                        <A 
                            href="/student" 
                            class={`${styles['nav-item']} ${isActive('student') && !isActive('schedule') && !isActive('grades') && !isActive('homework') ? styles.active : ''}`}
                        >
                            <FiHome size={20} />
                            <span>Главная</span>
                        </A>
                        <A 
                            ...
                            class={`${styles['nav-item']} ${isActive('schedule') ? styles.active : ''}`}
                        >
                            <FiCalendar size={20} />
                        ...
                        <A 
                            href="/student/grades" 
                            class={`${styles['nav-item']} ${isActive('grades') ? styles.active : ''}`}
                        >
                            <FiBook size={20} />
                            <span>Оценки</span>
                        </A>
                        <A 
                            ...
                            class={`${styles['nav-item']} ${isActive('homework') ? styles.active : ''}`}
                        >
                            <FiFileText size={20} />
                    ...
                    <div class={`${styles['user-menu']} ${isMobileMenuOpen() ? styles.active : ''}`}>
                ...
                <div class={styles['stat-card']}>
                    ...
                    <div class={styles['stat-content']}>
                        ...
                        <div class={styles['stat-progress']}>
                            <div 
                                class={styles['progress-bar']} 
                                style={{ width: `${(stats.completedHomework / stats.totalHomework) * 100}%` }}
                            />
                        </div>
                        <div class={styles['stat-description']}>
                            выполнено заданий
