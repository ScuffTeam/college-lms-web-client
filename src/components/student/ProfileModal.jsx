...
import { FiX, FiUser, FiMail, FiPhone, FiLock, FiCamera, FiSave } from 'solid-icons/fi';
                        ...
                        <form onSubmit={handleSubmit} class={styles['profile-form']}>
                            <div class={styles['avatar-section']}>
                                ...
                                <div class={styles['avatar-upload']}>
                                    ...
                                    />
                                    <label for="avatar-upload" class={styles['upload-label']}>
                                        <FiCamera size={20} />
                            ...
                            {success() && <div class={styles['success-message']}>{success()}</div>}
