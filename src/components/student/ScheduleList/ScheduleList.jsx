...
export function ScheduleList() {
  ...
  const goToPrevious = () => {
    ...
    if (viewMode() === VIEW_MODES.MONTH) {
      ...
      newDate.setDate(
        newDate.getDate() - (viewMode() === VIEW_MODES.WEEK ? 7 : 1)
      );
    }
    ...
    <div class={styles["schedule-section"]}>
      <div class={styles.scheduleControls}>
        <div class={styles.viewModeButtons}>
          <button
            class={`${styles.viewModeButton} ${
              viewMode() === VIEW_MODES.MONTH ? styles.active : ""
            }`}
          ...
          <button
            class={`${styles.viewModeButton} ${
              viewMode() === VIEW_MODES.WEEK ? styles.active : ""
            }`}
          ...
          <button
            class={`${styles.viewModeButton} ${
              viewMode() === VIEW_MODES.DAY ? styles.active : ""
            }`}
          ...
          <div class={styles.currentDate}>
            {viewMode() === VIEW_MODES.MONTH
              ...
              ? `${getMonthYear(
                ...
                )} - ${getMonthYear(getWeekDays(currentDate())[6])}`
              : getMonthYear(currentDate())}
          </div>
