...
export function HomeworkList() {
  ...
  onMount(async () => {
    try {
      ...
      setError(
        "Не удалось загрузить домашние задания. Пожалуйста, попробуйте позже."
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = "#";
      link.download = `${selectedHomework().subject}_${
  ...
  const renderHomeworkItem = (item) => {
    ...
    return (
      ...
      >
        ...
        <div class={styles["homework-content"]}>{item.description}</div>
          ...
          <div class={styles["modal"]} onClick={(e) => e.stopPropagation()}>
            ...
            <div class={styles["modalContent"]}>
              ...
              <div class={styles["file-upload"]}>
                ...
                <label
                  for="homework-upload"
                  class={styles["file-upload-label"]}
                >
                  <FiUpload size={24} />
                  ...
                  <div class={styles["uploaded-files"]}>
                    <div class={styles["uploaded-file"]}>
                      <div class={styles["file-info"]}>
                        <FiFileText size={20} />
                        <span class={styles["uploaded-file-name"]}>
                          {selectedFile().name}
                        </span>
                      </div>
                      <button
                        class={styles["remove-file"]}
